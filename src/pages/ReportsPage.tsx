  ...
  return (
    <div className="w-full min-h-screen bg-[#f2f7f8]">
      <div className="flex flex-col h-screen">
        {/* Navbar (conditionally rendered based on showNavbar prop) */}
        {showNavbar && <Navbar />}
                ...
                <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                  <div className="flex items-start gap-3 sm:gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <h1 className="font-rubik text-base sm:text-lg font-semibold mb-1 leading-[1.3]" style={{ color: "#231F20" }}>
                        Talent Pool employee list
                      </h1>
                      <p className="font-rubik text-xs sm:text-sm leading-[1.4]" style={{ color: "#231F20" }}>
