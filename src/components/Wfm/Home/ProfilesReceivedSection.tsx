            ...
            <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-4">
                    <div className="flex items-center gap-3">
                        <span className="text-[12px] font-semibold text-gray-500 whitespace-nowrap">Show profiles which need action</span>
                        <div className="relative inline-flex items-center cursor-pointer bg-[#00b894] rounded-full w-14 h-[24px] px-1.5 shadow-sm">
                            <span className="text-[11px] font-bold text-white text-center w-[22px] h-[14px] font-['Rubik',sans-serif]">YES</span>
                    ...
                    <div className="flex items-center gap-4">
                        <div className="bg-white p-1 rounded-md shadow-sm border border-gray-100 flex items-center justify-center w-[44px] h-[44px]">
                            <button className="hover:bg-gray-50 rounded-md transition-colors border-none bg-transparent flex items-center justify-center">
                                <img src={excelIcon} alt="Export to Excel" className="h-9 w-9" />
                            </button>
                        </div>
                        ...
                        <div className="flex items-center bg-white rounded-md shadow-sm border border-gray-100 divide-x divide-gray-100">
                            <button
                                ...
                                className={`p-2.5 transition-colors ${viewMode === 'grid' ? 'text-gray-800 bg-gray-50/50' : 'text-gray-300 hover:text-gray-500'}`}
                            >
                                <LayoutGrid className="h-5 w-5" />
                            </button>
                            <button
                                onClick={() => setViewMode('list')}
                                className={`p-2.5 transition-colors ${viewMode === 'list' ? 'text-gray-800 bg-gray-50/50' : 'text-gray-300 hover:text-gray-500'}`}
                            >
