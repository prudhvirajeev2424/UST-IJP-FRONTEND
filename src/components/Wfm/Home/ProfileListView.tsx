    ...
    return (
        <div className="w-full overflow-x-auto">
            ...
            <div className="min-w-[1000px]">
                ...
                >
                    <div className="w-[15%] text-[13px] font-bold text-gray-400 font-['Rubik',sans-serif]">SO#</div>
                    <div className="w-[20%] text-[13px] font-bold text-gray-400 font-['Rubik',sans-serif]">Role</div>
                    <div className="w-[10%] text-[13px] font-bold text-gray-400 font-['Rubik',sans-serif]">Band</div>
                    <div className="w-[15%] text-[13px] font-bold text-gray-400 font-['Rubik',sans-serif]">Location</div>
                    <div className="w-[20%] text-[13px] font-bold text-gray-400 font-['Rubik',sans-serif]">Account</div>
                    <div className="w-[20%] text-right text-[13px] font-bold text-gray-400 font-['Rubik',sans-serif]">Action Taken</div>
                </div>
