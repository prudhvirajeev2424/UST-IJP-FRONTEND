...
import Avatar from "../../TP_Manager/application/common/Avatar";
import Button from "../../TP_Manager/application/common/Button";
import ShortlistModal from "../../TP_Manager/application/shortListModal/ShortlistModal"; // Import the ShortlistModal
import { useShortlist } from "../../TP_Manager/application/context/ShortlistContext";
import { useActiveRole } from "../../../context/ActiveRoleContext";
import ApprovalModal from "../Home/ApproveConfirmationDialog";
import RejectModal from "../../Wfm/Home/RejectionConfirmation";
