  ...
  return (
    <Card className="bg-card border border-border animate-fade-in h-full">
      ...
      <CardContent className="space-y-6">
        <div>
          <h4 className="text-sm font-semibold text-foreground mb-3">Must Have Skills</h4>
        ...
        <div>
          <h4 className="text-sm font-semibold text-foreground mb-2">Good to Have Skills</h4>
          <div className="flex flex-wrap gap-2">
        ...
        <div>
          <h4 className="text-sm font-semibold text-foreground mb-2">Job Summary</h4>
          <p className="text-sm text-muted-foreground leading-relaxed">{jobSummary}</p>
        </div>
