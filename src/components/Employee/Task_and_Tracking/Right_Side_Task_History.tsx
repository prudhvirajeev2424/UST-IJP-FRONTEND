              ...
              <div className="overflow-hidden">
                <div className="px-10 pb-8 border-t border-[#E6EEF0] bg-white">
                  ...
                  >
                    ...
                    <div className="w-[100px] h-[49px] border border-[#D7E0E3] rounded-[5px] flex items-center justify-between px-4 bg-white">
                      <span className="text-[14px] text-[#231F20] whitespace-nowrap">
                        {task.progress}%
                      </span>
                    </div>
                  </div>
