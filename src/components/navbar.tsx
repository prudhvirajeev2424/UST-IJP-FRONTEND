...
const Navbar = ({ role = "Employee" }: NavbarProps) => {
  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex-shrink-0">
              <div className="flex items-center">
                <span className="text-2xl font-bold text-[#003c51]">
                  UST
                </span>
                <span className="text-2xl font-light ml-1 text-[#7a7480]">
                  IJP
                </span>
              </div>
            </div>
            ...
            <div className="flex-shrink-0 flex items-center gap-4 relative">
              <Mail size={24} className="text-gray-700 cursor-pointer hover:text-gray-900" />
              ...
              <div className="relative">
                ...
                />
                <span className="absolute -top-1.5 -right-1.5 flex h-4 w-4 items-center justify-center rounded-full bg-red-500 text-[10px] text-white font-semibold">
                  3
                </span>
                ...
                {showNotifications && (
                  <div className="absolute right-0 mt-3 w-96 rounded-xl bg-teal-700 text-white shadow-xl">
                    ...
                    <div className="divide-y divide-teal-600">
                      <div className="flex gap-3 px-4 py-3 hover:bg-teal-600 cursor-pointer transition-colors">
                        <img
                         src={ProfilePic}
                      ...
                      <div className="flex gap-3 px-4 py-3 hover:bg-teal-600 cursor-pointer transition-colors">
                        <div className="h-9 w-9 rounded-full bg-teal-600 flex items-center justify-center flex-shrink-0">
      ...
      {/* Page Content - Only show EmpHome when Home is clicked */}
      {active === "Home" && role === "Employee" && (
          <EmpHome />
      )}
    </>
  );
