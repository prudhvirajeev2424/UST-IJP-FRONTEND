...
const RecentActivities: React.FC = () => {
  return (
  <div className="flex h-[465px] w-full flex-col rounded-lg bg-white p-[20px_20px_30px_20px] shadow-sm">
      ...
      <div className="mb-4 flex items-center justify-between border-b border-gray-200 pb-[5px]">
        <h2 className="text-[16px] font-medium text-[#231F20]">Recent Activities</h2>
        ...
        {activities.map((a, i) => (
          <div
            ...
            className={`relative pb-6 pl-6 ${
              i === activities.length - 1 ? "border-l-0" : "border-l-2 border-gray-200"
            }`}
          >
            {/* DOT */}
            ...
            <p className="mb-1 text-[14px] leading-[22px] text-[#231F20]">
              Application for <span className="font-semibold">"{a.candidate}"</span>
            </p>
            ...
            <div className="flex items-center justify-between">
              <span
                className={`rounded px-[10px] py-[3px] text-[12px] font-medium ${
                  a.status === "Allocated" ? "bg-teal-100 text-[#0097AC]" : "bg-red-100 text-red-500"
                }`}
              >
                {a.status}
              </span>
