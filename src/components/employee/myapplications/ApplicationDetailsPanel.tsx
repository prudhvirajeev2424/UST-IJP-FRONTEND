    ...
    <>
      ...
      <div className="fixed right-0 top-0 bottom-0 w-[750px] bg-white shadow-2xl z-[999] overflow-y-auto rounded-l-2xl">
        ...
        <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between rounded-tl-2xl">
          ...
          <button
            onClick={onClose}
            className="text-[#7A7480] hover:text-[#231F20] transition-colors"
          >
        ...
        <div className="px-6 py-5 space-y-6">
          ...
          <div className="bg-[#F7F9FA] rounded-lg p-5 space-y-5">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                <label className="block text-[12px] font-medium text-[#7A7480] mb-1 leading-tight">
                  SO#
                </label>
                <p className="text-[14px] font-normal text-[#231F20] leading-tight">
                  32443388
                </p>
              </div>
              <div>
              ...
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <label className="text-[12px] font-medium text-[#7A7480] leading-tight">
                    Hiring Manager
                  </label>
            ...
            {/* Required Skills */}
            <div>
              <label className="block text-[12px] font-medium text-[#7A7480] mb-2 leading-tight">
                Required Skills
              </label>
              <div className="flex flex-wrap gap-2">
                {["Java", "Selenium", "C++", "Python"].map((skill) => (
                  <span
                    key={skill}
                    className="inline-flex items-center rounded-full bg-[#ECEEE8] px-3 py-1.5 text-[13px] font-normal text-[#231F20] leading-tight"
                  >
                    {skill}
                  </span>
                ))}
            ...
            <div className="space-y-0">
              ...
              <div className="flex gap-3">
                ...
                <div className="flex-1 pb-6">
                  ...
                  <p className="text-[12px] text-[#7A7480] mt-0.5 leading-tight">
                    Pending approval from WFM
                  </p>
                  <p className="text-[11px] text-[#7A7480] mt-0.5 leading-tight">
                    4th December, 2024
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div className="flex-1">
                  <p className="text-[14px] font-normal text-[#7A7480] leading-tight">
          ...
          <div className="rounded-lg bg-red-50 p-4 border border-red-100">
            <h3 className="text-[16px] font-medium text-[#231F20] mb-3 leading-tight">
              Reason for Rejection
            </h3>
            <p className="text-[14px] text-[#231F20] leading-relaxed">
              While your portfolio demonstrated strong design skills, we were
              looking for more experience with enterprise-level design systems
              and accessibility standards. We found a candidate with more
              relevant experience in these specific areas. We encourage you to
              apply for future UX positions as your skills continue to develop.
            </p>
          </div>
        </div>
      </div>
