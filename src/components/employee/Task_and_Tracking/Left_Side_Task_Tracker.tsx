  ...
  return (
    ...
    <div className="w-[360px] h-[424px] bg-white rounded-[10px] relative shadow-sm shrink-0">
      <div className="absolute top-[30px] w-full text-center">
        <h3 className="text-[16px] font-medium leading-[19px] text-[#231F20]">
      ...
      <div className="absolute top-[104px] left-[104px] w-[152px] h-[152px]">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <span className="text-[32px] leading-[38px] text-[#231F20]">
            0{stats.total}
          </span>
      ...
      <div className="absolute bottom-[40px] w-full flex justify-between px-[30px]">
        <div className="text-center">
          <div className="text-[32px] text-[#01B27C] leading-[38px]">
            0{stats.completed}
          </div>
          <div className="text-[16px] text-[#231F20]">Completed</div>
        </div>
        <div className="text-center">
          <div className="text-[32px] text-[#FFBF00] leading-[38px]">
            0{stats.inProgress}
          </div>
          <div className="text-[16px] text-[#231F20]">In Progress</div>
        </div>
        <div className="text-center">
          <div className="text-[32px] text-[#FC6A59] leading-[38px]">
            0{stats.yetToStart}
          </div>
          <div className="text-[16px] text-[#231F20]">
