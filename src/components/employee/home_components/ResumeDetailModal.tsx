  ...
  experiences: [
    {
      ...
      company: "UST",
      description:
        "Architected and implemented microservices-based applications using Spring Boot, Hibernate, and RESTful APIs. Led a team of 5 developers, conducting code reviews and improving overall code quality.",
    ...
    },
    {
      ...
      description:
        "Developed enterprise applications using Java EE, Spring MVC, and MySQL. Designed RESTful web services for seamless integration with front-end applications.",
    ...
    },
    {
      ...
      description:
        "Assisted in developing and testing Java-based applications. Wrote reusable code modules and optimized legacy systems. Conducted unit testing using JUnit and ensured code adherence to best practices.",
      skills: ["Java EE"],
    },
  ],
  education: [
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-border shrink-0">
          ...
          <div className="flex items-center gap-3">
            <span className="text-sm text-muted-foreground">
              Applied on {resumeData.appliedDate}
            </span>
            <button
              onClick={openDrawer}
        ...
        <div
          id="resume-modal-scroll"
          className="flex-1 overflow-y-auto hide-scrollbar p-6 space-y-8 text-left"
        ...
        >
          ...
          <section>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Total {resumeData.totalExperience} as Java Developer
            </p>
                        ...
                        <div className="flex flex-wrap gap-2 mt-3">
                          {exp.skills.map((skill) => (
                            <div
                              ...
                              role="listitem"
                            >
                              <span className="skill-text inner-small">
                                {skill}
                              </span>
                            </div>
                          ))}
          ...
          <section>
            ...
            <div className="grid grid-cols-3 gap-4">
              {resumeData.certifications.map((cert, index) => (
                <div
                  key={index}
                  className="cert-box p-4 flex flex-col items-start justify-center"
                >
                  <img
                    src={certIconPath}
                    alt="cert"
          ...
          <section>
            ...
            <div className="grid grid-cols-3 gap-4">
              {resumeData.accolades.map((accolade, index) => (
                <div
                  key={index}
                  className="accolade-box p-4 flex flex-col items-start justify-center"
                >
                  <div className="w-12 h-12 mb-3 flex items-center justify-center">
                    <img
                      src={accoladeIconPath}
                      alt="accolade"
                      className="w-10 h-10 object-contain"
                    />
                  </div>
                ...
                <div key={testimonial.id} className="testimonial-box p-5">
                  <div className="mb-2">
                    <img
                      src={quoteIconPath}
                      alt="quote"
                      className="w-6 h-6 object-contain text-muted-foreground"
                    />
                  </div>
